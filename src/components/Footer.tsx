        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-10">
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4">
              <img src={footerLogo} alt="Buzz Connect" className="h-24 w-auto" loading="lazy" />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/70">
              ...
              <li><Link to="/lead-follow-up-services-sri-lanka" className="hover:text-accent transition-colors">Lead Follow-Up Services</Link></li>
              ...
              <li><Link to="/programmatic-advertising-sri-lanka" className="hover:text-accent transition-colors">Programmatic Advertising</Link></li>
